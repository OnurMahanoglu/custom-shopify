...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-custom-validation/src/Checkout.jsx
  ...
  function Extension() {
    ...
    useBuyerJourney(({ canBlockProgress: canBlockProgress2 }) => {
      if (canBlockProgress2 && !isZipCodeCorrect()) {
        return {
          behavior: "block",
      ...
      if (canBlockProgress2 && !isPhoneCorrect()) {
        return {
          behavior: "block",
          reason: `Phone Length.`,
          errors: [
    ...
    if (areaStatus != null && infoText != null && title != null) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title, status: areaStatus, children: infoText });
    } else {
      return null;
    }
  }
})();
//# sourceMappingURL=checkout-custom-validation.js.map
