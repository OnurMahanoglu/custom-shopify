...
import type { BackgroundProps, BlockAlignment, BorderProps, Columns, CornerProps, InlineAlignment, Rows, SizingProps, Spacing, SpacingProps, ViewLikeAccessibilityRole } from '../shared';
export interface GridProps extends Pick<BackgroundProps, 'background'>, BorderProps, CornerProps, SizingProps, SpacingProps {
    /**
