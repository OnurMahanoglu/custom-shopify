...
import type { CartLineItemApi, PaymentOptionItemApi, PickupLocationListApi, RedeemableApi, ShippingOptionItemApi, PickupPointListApi, StandardApi, CheckoutApi, OrderStatusApi, ShippingOptionListApi } from './api';
...
export interface ExtensionTargets {
     ...
     */
    'purchase.thank-you.header.render-after': RenderExtension<StandardApi<'purchase.thank-you.header.render-after'>, AnyComponent>;
    /**
     * A static extension target that is rendered below the footer on the **Thank you** page.
     */
    'purchase.thank-you.footer.render-after': RenderExtension<StandardApi<'purchase.thank-you.footer.render-after'>, AnyComponent>;
}
