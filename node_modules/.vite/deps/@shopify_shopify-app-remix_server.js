...
import {
  require_app_bridge_url,
  require_const,
  require_isbot
} from "./chunk-OOGGIBXM.js";
import {
  init_tslib_es6,
  require_runtime,
  tslib_es6_exports
...
var require_types = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var AppDistribution = function(AppDistribution2) {
    ...
    var LoginErrorType = function(LoginErrorType2) {
...
var require_version = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/version.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var SHOPIFY_REMIX_LIBRARY_VERSION = "2.6.1";
...
var require_reject_bot_request = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/helpers/reject-bot-request.js"(exports) {
    ...
    var isbot__default = _interopDefaultLegacy(isbot);
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/helpers/validate-redirect-url.js
var require_validate_redirect_url = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/helpers/validate-redirect-url.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var shopifyApi = require_lib();
    var FILE_URI_MATCH = /\/\/\//;
...
var require_render_app_bridge = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/helpers/render-app-bridge.js"(exports) {
    ...
    var validateRedirectUrl = require_validate_redirect_url();
...
var require_override_logger = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/override-logger.js"(exports) {
    ...
    var semver__default = _interopDefaultLegacy(semver);
    function overrideLogger(logger) {
      ...
      function deprecated(warningFunction2) {
        return function(version$1, message) {
          ...
          return warningFunction2(`[Deprecated | ${version$1}] ${message}`);
        };
      }
      return {
        ...logger,
...
var require_shopify_app = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/shopify-app.js"(exports) {
    ...
    function deriveApi(appConfig) {
      var _appConfig$isEmbedded, _appConfig$apiVersion, _appConfig$future;
      let appUrl;
      try {
      ...
      return shopifyApi.shopifyApi({
        ...
        future: {
          v10_lineItemBilling: (_appConfig$future = appConfig.future) === null || _appConfig$future === void 0 ? void 0 : _appConfig$future.v3_lineItemBilling
        }
      });
    }
    function deriveConfig(appConfig, apiConfig) {
      var _appConfig$distributi, _appConfig$useOnlineT, _appConfig$hooks, _appConfig$future2;
      ...
      return {
        ...
        future: (_appConfig$future2 = appConfig.future) !== null && _appConfig$future2 !== void 0 ? _appConfig$future2 : {},
        auth: {
          path: authPathPrefix,
